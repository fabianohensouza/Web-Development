	    ...
	    <div class="container">
	    	...
	    	<div class="row mb-2">
	    		...
	    		<div class="col-md-4 center">
	    			<a href="pagina_1.php" class="btn btn-primary">Página 1</a>
	    			<a href="pagina_2.php" class="btn btn-primary">Página 2</a>
	    			<a href="pagina_3.php" class="btn btn-primary">Página 3</a>
	    		</div>
	    		<div class="col-md-4 center"></div>
	    	</div>
